...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'approba_machine', (
            ...
            ('machine_name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
    ...
    models = {
        u'approba.machine': {
            ...
            'machine_name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100'}),
